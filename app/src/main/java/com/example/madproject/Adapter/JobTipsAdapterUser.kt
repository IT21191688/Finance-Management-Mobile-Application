...
class JobTipsAdapterUser(JobTips:List<JobTipsModal>, internal var context: Context): RecyclerView.Adapter<JobTipsAdapterUser.JobTipsViewHolder>() {
    ...
    inner class JobTipsViewHolder(view: View): RecyclerView.ViewHolder(view){
        ...
        var tipTitle: TextView =view.findViewById(R.id.jobTipTitle)
        var tipDiscription: TextView =view.findViewById(R.id.jobTipDiscription)


    }
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): JobTipsViewHolder {
        val view= LayoutInflater.from(context).inflate(R.layout.jobtipsuserread,parent,false)
